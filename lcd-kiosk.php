...
<head>
    ...
    <meta content="LCD and digital kiosks by PIXON TECHNOLOGIES." name="description" />
    <meta
    ...
    <title>LCD &amp; Kiosk - PIXON TECHNOLOGIES</title>
    ...
    <main>
                ...
                <div class="container">
                    <div class="animate-fade-in-up" style="max-width: 850px; margin: 0 auto; text-align: center;">
                        ...
                        <p class="hero-sub"
                            ...
                            Interactive digital kiosks, smart posters, and ultra-narrow bezel video walls for engaging
                            spaces.
                        </p>
                    </div>
                </div>
        ...
        <section class="section light-section" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container" style="text-align: center;">
                ...
                <p class="section-sub">We are currently updating our site with detailed specs and features for LCD &amp;
                    Kiosk.</p>
