...
<head>
    ...
    <meta content="Innovative and custom LED screens by PIXON TECHNOLOGIES." name="description" />
    <meta
    ...
    <title>Innovative LED Screens - PIXON TECHNOLOGIES</title>
    ...
    <main>
                ...
                <div class="container">
                    <div class="animate-fade-in-up" style="max-width: 850px; margin: 0 auto; text-align: center;">
                        ...
                        <p class="hero-sub"
                            ...
                            Pushing the boundaries of display technology with kinetic, spherical, and transparent
                            screens.
                        </p>
                    </div>
                </div>
        ...
        <section class="section light-section" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container" style="text-align: center;">
                <h2 class="section-title">More details coming soon</h2>
                <p class="section-sub">We are currently updating our site with detailed specs and features for
                    Innovative LED Screens.</p>
                <div style="margin-top: 40px; text-align: center;">
                    <a class="btn-ghost-white" href="services.php">Back to all Services</a>
                </div>
            </div>
        </section>
    </main>
