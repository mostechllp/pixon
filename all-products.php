...
<head>
    ...
    <meta content="Explore all premium display products by PIXON TECHNOLOGIES." name="description" />
    <meta
    ...
    <main>
                ...
                <div class="container">
                    <div class="animate-fade-in-up" style="max-width: 850px; margin: 0 auto; text-align: center;">
                        ...
                        <p class="hero-sub"
                            ...
                            Explore our comprehensive range of display solutions for every environment.
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section class="section light-section" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container" style="text-align: center;">
                ...
                <p class="section-sub">We are currently updating our site with detailed specs and features for All
                    Products.</p>
