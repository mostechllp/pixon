...
<head>
    ...
    <meta content="Weatherproof outdoor display products by PIXON TECHNOLOGIES." name="description" />
    <meta
    ...
    <title>Outdoor Products - PIXON TECHNOLOGIES</title>
    ...
    <main>
                ...
                <div class="container">
                    <div class="animate-fade-in-up" style="max-width: 850px; margin: 0 auto; text-align: center;">
                        ...
                        <p class="hero-sub"
                            ...
                            High-brightness, weatherproof LED screens engineered for extreme conditions and maximum
                            visibility.
                        </p>
                    </div>
                </div>
        ...
        <section class="section light-section" style="padding-top: 80px; padding-bottom: 80px;">
            <div class="container" style="text-align: center;">
                ...
                <p class="section-sub">We are currently updating our site with detailed specs and features for Outdoor
                    Products.</p>
