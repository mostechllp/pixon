...
<p class="hero-sub" style="margin-bottom: 36px; max-width: 720px; margin-left: auto; margin-right: auto;">
                            We specialize in designing and producing bespoke digital content tailored specifically for your LED screens and unique business needs. From stunning 3D animations and dynamic motion graphics to captivating brand storytelling, we create high-impact visuals that grab attention and engage your audience perfectly.
                        </p>
</div>
</div>
</div>
...
<div class="section-label" style="color: var(--blue-accent);">Creative Horizons</div>
<h2 class="section-title" style="margin-bottom: 0;">
                            Engaging Digital <span class="hero-title-accent">Content</span>
</h2>
...
<img alt="Content Creation Applications" src="assets/content_creation_hero.webp" style="width: 100%; height: 100%; object-fit: cover;"/>
</div>
</div>
</div>
</div>
...
<!-- Right: Content -->
<div class="about-content-showcase reveal">
<div class="section-label" style="color: var(--blue-accent);">Advanced Engineering</div>
<h2 class="section-title" style="margin-bottom: 0;">
                            Why Choose Our <span class="hero-title-accent">Content Services</span>
</h2>
<p class="about-story-text" style="color: var(--text-secondary); margin-bottom: 0;">
...
<div class="about-visual-showcase reveal reveal-delay-2">
<div class="about-showcase-frame" style="height: 100%; border-radius: 24px; overflow: hidden; border: 1px solid var(--glass-border);">
<img alt="Content Creation Services" src="assets/content_services_features.webp" style="width: 100%; height: 100%; object-fit: cover;"/>
</div>
</div>
</div>
</div>
...
<span style="color: #512BFF; font-weight: 700; letter-spacing: 3px; font-size: 12px; text-transform: uppercase;">Bring Your Vision To Life</span>
...
<h2 style="font-size: clamp(32px, 4vw, 48px); font-weight: 800; line-height: 1.2; margin-bottom: 20px; color: #111111 !important; -webkit-text-fill-color: #111111 !important;">
                    Ready to Design Your<br/>Custom LED Solution?
                </h2>
<p style="font-size: 18px; color: #555555; line-height: 1.6; margin-bottom: 40px; font-weight: 400; max-width: 600px; margin-left: auto; margin-right: auto;">
                    Collaborate with our engineering team to design, manufacture, and install custom digital displays that fit your space perfectly. Let's start shaping your reality.
                </p>
