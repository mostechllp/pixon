                ...
                <div class="container">
                    <div class="animate-fade-in-up" style="max-width: 800px; margin: 0 auto; text-align: center;">
                        ...
                        <p class="hero-sub"
                            ...
                            Create an unforgettable centerpiece with seamless spherical LED screens. Perfect for
                            museums, planetariums, and high-end exhibitions demanding complete omnidirectional
                            visibility.
                        </p>
                    </div>
                </div>
        ...
        <section class="section light-section">
            <div class="container">
                <div class="section-header text-center">
                    ...
                    <p class="section-sub">Discover what makes Spherical LED Screen the ideal choice for your business
                    </p>
                </div>
                <div class="features-grid">
                    ...
                    <div class="feature-card reveal">
                        ...
                        <p class="feature-desc">Motorized kinetic systems allow screens to physically move, separate,
                            and reassemble.</p>
                    </div>
                    <!-- Feature 2 -->
                    ...
                    <div class="feature-card reveal reveal-delay-2">
                        ...
                        <p class="feature-desc">Bespoke flexible modules can be mapped to virtually any architectural
                            shape or curve.</p>
                    </div>
                    <!-- Feature 4 -->
                    ...
                    <div class="feature-card reveal reveal-delay-4">
                        ...
                        <p class="feature-desc">Transform structural columns, ceilings, and unique spaces into digital
                            centerpieces.</p>
                    </div>
                    <!-- Feature 6 -->
            ...
            <div class="container">
                ...
                <div class="applications-grid">
                    ...
                    <div class="application-card reveal reveal-delay-5">
                        ...
                        <p class="application-desc">Integrate technology into urban landscapes with flexible and mesh
                            structures.</p>
                    </div>
                    <!-- Application 7 -->
                    <div class="application-card reveal">
        ...
        <section class="light-section section gallery-section" id="gallery">
            <div class="container">
                <div class="section-header text-center">
                    ...
                    <h2 class="section-title">Spherical LED Screen <span class="hero-title-accent">References</span>
                    </h2>
                </div>
                <div class="bento-gallery">
                    ...
                    <div class="bento-item reveal reveal-delay-1">
                        <img alt="Corporate Lobby Display"
